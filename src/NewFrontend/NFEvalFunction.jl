    ...
    @match (name, args) begin
      ...
      (
        ...
        TUPLE_EXPRESSION(
          ...
          list(STRING_EXPRESSION(s1), P_Expression.Expression.BOOLEAN(b)),
        )
      end
      ...
      (
        ...
        STRING_EXPRESSION(s2) <| P_Expression.Expression.BOOLEAN(b) <| nil(),
      ) => begin
      ...
      (
        ...
        STRING_EXPRESSION(s1) <|
        INTEGER_EXPRESSION(i) <| P_Expression.Expression.BOOLEAN(b) <| nil(),
      ) => begin
      ...
      (
        ...
        INTEGER_EXPRESSION(i2) <| P_Expression.Expression.BOOLEAN(b) <| nil(),
      ) => begin
