module HashTableStringToProgram
...
function emptyHashTableSized(size::Integer)::HashTable
  ...
  @assign hashTable =
    BaseHashTable.emptyHashTableWork(size, (stringHashDjb2Mod, stringEq, Util.id, dummyStr))
  return hashTable
end

function dummyStr(p::Absyn.Program)::String
  local str::String = "<dummy Absyn.Program string>"
  return str
end
